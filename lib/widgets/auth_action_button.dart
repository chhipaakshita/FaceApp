import 'package:face_xc/database/database.dart';
...
Future _signUp(context) async {
  ...
  print('face detect signup bootom sheet');
...
class _AuthActionButtonState extends State<AuthActionButton> {
  ...
  Scaffold.of(context).showBottomSheet((context) => signSheet(context,predictedUser));
